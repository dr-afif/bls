...
const resources: CourseResource[] = [
  { id: "one", versionId: "version-one", slug: "chain", title: "Chain of survival", summary: "Recognition reference", type: "guide", estimatedMinutes: 4, featured: true, versionNumber: 1, guidelineSource: "Fictional", guidelineYear: 2026, reviewedAt: null, nextReviewAt: null, youtubeVideoId: null, contentLanguage: "en", content: { kind: "guide", sections: [{ heading: "Recognise", body: "Call for help" }] }, topics: [{ id: "topic-one", name: "Recognition", slug: "recognition", displayOrder: 1 }], teachingStages: [{ id: "stage-one", name: "Reinforce", slug: "reinforce", displayOrder: 1 }], relatedResourceIds: [] },
  { id: "two", versionId: "version-two", slug: "aed", title: "AED quick guide", summary: "AED reference", type: "pdf", estimatedMinutes: 5, featured: false, versionNumber: 1, guidelineSource: "Fictional", guidelineYear: 2026, reviewedAt: null, nextReviewAt: null, youtubeVideoId: null, contentLanguage: "ms", content: null, topics: [{ id: "topic-two", name: "AED", slug: "aed", displayOrder: 2 }], teachingStages: [{ id: "stage-one", name: "Reinforce", slug: "reinforce", displayOrder: 1 }], relatedResourceIds: [] },
];
...
describe("ResourceLibraryPage", () => {
  ...
  it("filters resources by content language and defaults to All languages without hiding resources", async () => {
    const user = userEvent.setup();
    render(<MemoryRouter><ResourceLibraryPage scope="learner" /></MemoryRouter>);

    // By default "All languages" is active and shows both EN and MS resources
