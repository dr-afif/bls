-- Migration: 20260819133000_milestone_6_csv_exports_corrections.sql
-- Corrective migration for Milestone 6 Phase 6.4 CSV Exports:
-- 1. Enforce deterministic tie-breaking (ORDER BY qa.learner_id, qa.submitted_at DESC, qa.id DESC)
-- 2. Remove learnerEmail from export projections as email is not an authorized public application field

-- 1. Cohort Roster Export Correction
...
-- 2. Assessment Results Export Correction
...
-- 3. Pre/Post Comparison Export Correction
